...
def read_file(
    ...
    file_path: Annotated[list[str], "list of paths of the file inside the repo, e.g. 'src/main.py'"],
    ...
    """
    Reads the content of 1 or more files from a GitHub repository. 
    ...
    if file_path is None or len(file_path) == 0:
        return json.dumps({"error": "at list one file path must be provided"})
    ...
    for file in file_path:
        for b in branches_to_try:
            url = f"https://api.github.com/repos/{repo_full_name}/contents/{file}?ref={b}"
